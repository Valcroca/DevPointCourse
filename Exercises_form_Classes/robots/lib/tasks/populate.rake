  ...
  task data: :environment do
    Inventor.populate 50 do |inventor|
      ...
      Robot.populate Faker::Number.between(1, 10) do |robot|
        ...
        robot.color = ['Gray', 'Black', 'Blue', 'Green', 'White', 'Red'].sample
